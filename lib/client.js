window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const visibility = require('@sharewiner/dsh-model-management/model-visibility');
    const directoryCompat = require('@sharewiner/dsh-model-management/model-directory-compat');
    const css = `
